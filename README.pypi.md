...
**Give Claude Code or Codex the Power BI skills it needs.**
Install once, then ask your agent to work with semantic models *and* reports.
...
pbi-cli gives **Claude Code, Codex, and other AI agents** the ability to manage Power BI semantic models **and reports**. It ships with 12 skills that the agent discovers automatically. You ask in plain English, the agent uses the right `pbi` commands.

```
You                        Claude/Codex             pbi-cli              Power BI
...
**Fastest way:** Just give Codex the repo URL and let it handle everything:
...
For Codex, use `pbi-cli skills install --agent codex`.

Open Power BI Desktop with a `.pbix` file, run the three commands above, and start asking your agent.
