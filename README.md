...
<p align="center">
  <b>Give Claude Code or Codex the Power BI skills it needs.</b><br/>
  Install once, then ask your agent to work with semantic models <i>and</i> reports.
</p>
...
See [CODEX_SETUP.md](CODEX_SETUP.md) for platform notes.
...
For Claude Code, use `pbi-cli skills install` instead of `pbi-cli skills install --agent codex`.

> **Requires:** Windows with Python 3.10+ and Power BI Desktop running.

<details>
<summary><b>Alternative: give Codex the repo URL</b></summary>

```
Install and set up pbi-cli from https://github.com/MinaSaad1/pbi-cli.git
```

Codex can clone, install, connect, and set up skills automatically.
